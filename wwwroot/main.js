...
var PreventUnsavedChangesGuard = /** @class */ (function () {
    function PreventUnsavedChangesGuard(authService, alertify, router) {
        this.authService = authService;
        this.alertify = alertify;
        this.router = router;
    }
...
var ListsResolver = /** @class */ (function () {
    ...
    ListsResolver.prototype.resolve = function (route) {
        ...
        return this.userService.getUsers(this.pageNumber, this.pageSize, null, this.likesParam).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(null); // null observable
        }));
    };
...
var MessagesResolver = /** @class */ (function () {
    function MessagesResolver(userService, alertify, auth, router) {
        this.userService = userService;
        this.alertify = alertify;
        this.auth = auth;
        this.router = router;
    ...
    MessagesResolver.prototype.resolve = function (route) {
        var _this = this;
        return this.userService.getMessages(this.auth.decodedToken.nameid, this.pageNumber, this.pageSize, this.messageContainer).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
...
var AlertifyService = /** @class */ (function () {
    ...
    AlertifyService.prototype.confirm = function (message, okCllback) {
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getMessages = function (id, page, itemsPerPage, messageContainer) {
        ...
        return this.http
            ...
            paginatedResult.result = response.body;
            if (response.headers.get('Pagination') != null) {
                paginatedResult.pagination = JSON.parse(response.headers.get('Pagination') // Json string to object
                );
            }
            return paginatedResult;
        }));
...
/***/ "./src/app/app-ngx-bootstrap.module.ts":
/*!*********************************************!*\
  !*** ./src/app/app-ngx-bootstrap.module.ts ***!
  \*********************************************/
/*! exports provided: AppNgxBootstrapModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppNgxBootstrapModule", function() { return AppNgxBootstrapModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var AppNgxBootstrapModule = /** @class */ (function () {
    ...
    AppNgxBootstrapModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                ...
                ngx_bootstrap__WEBPACK_IMPORTED_MODULE_2__["ButtonsModule"].forRoot()
            ],
            exports: [
                ngx_bootstrap__WEBPACK_IMPORTED_MODULE_2__["BsDropdownModule"],
                ngx_bootstrap__WEBPACK_IMPORTED_MODULE_2__["TabsModule"],
                ngx_bootstrap__WEBPACK_IMPORTED_MODULE_2__["BsDatepickerModule"],
                ngx_bootstrap__WEBPACK_IMPORTED_MODULE_2__["PaginationModule"],
                ngx_bootstrap__WEBPACK_IMPORTED_MODULE_2__["ButtonsModule"]
            ]
        })
...
/* harmony import */ var _app_ngx_bootstrap_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./app-ngx-bootstrap.module */ "./src/app/app-ngx-bootstrap.module.ts");
...
/* harmony import */ var time_ago_pipe__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! time-ago-pipe */ "./node_modules/time-ago-pipe/esm5/time-ago-pipe.js");
...
/* harmony import */ var _services_alertify_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./_services/alertify.service */ "./src/app/_services/alertify.service.ts");
...
/* harmony import */ var _lists_lists_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./lists/lists.component */ "./src/app/lists/lists.component.ts");
...
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./_services/user.service */ "./src/app/_services/user.service.ts");
/* harmony import */ var _members_member_card_member_card_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./members/member-card/member-card.component */ "./src/app/members/member-card/member-card.component.ts");
/* harmony import */ var _members_member_detail_member_detail_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./members/member-detail/member-detail.component */ "./src/app/members/member-detail/member-detail.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _lists_lists_component__WEBPACK_IMPORTED_MODULE_23__["ListsComponent"],
                _messages_messages_component__WEBPACK_IMPORTED_MODULE_24__["MessagesComponent"],
                _members_member_card_member_card_component__WEBPACK_IMPORTED_MODULE_28__["MemberCardComponent"],
                _members_member_detail_member_detail_component__WEBPACK_IMPORTED_MODULE_29__["MemberDetailComponent"],
            ...
            imports: [
                ...
                _app_ngx_bootstrap_module__WEBPACK_IMPORTED_MODULE_5__["AppNgxBootstrapModule"],
                ngx_gallery__WEBPACK_IMPORTED_MODULE_8__["NgxGalleryModule"],
                ng2_file_upload__WEBPACK_IMPORTED_MODULE_9__["FileUploadModule"],
                _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"].forRoot(_routes__WEBPACK_IMPORTED_MODULE_25__["appRoutes"]),
            ...
            providers: [
                ...
                _services_alertify_service__WEBPACK_IMPORTED_MODULE_21__["AlertifyService"],
                ...
                _guards_prevent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_13__["PreventUnsavedChangesGuard"],
                _resolvers_member_detail_resolver__WEBPACK_IMPORTED_MODULE_10__["MemberDetailResolver"],
                _resolvers_member_list_resolver__WEBPACK_IMPORTED_MODULE_11__["MemberListResolver"],
                _resolvers_member_edit_resolver__WEBPACK_IMPORTED_MODULE_12__["MemberEditResolver"],
...
var MemberCardComponent = /** @class */ (function () {
    function MemberCardComponent(userService, alertify, authService) {
        this.userService = userService;
        this.alertify = alertify;
        this.authService = authService;
    }
...
var MemberEditComponent = /** @class */ (function () {
    function MemberEditComponent(userService, authService, alertify, route) {
        this.userService = userService;
        this.authService = authService;
        this.alertify = alertify;
        this.route = route;
    ...
    MemberEditComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"],
...
var MemberMessagesComponent = /** @class */ (function () {
    ...
    MemberMessagesComponent.prototype.sendMessage = function () {
        ...
        this.userService.sendMessage(this.authService.decodedToken.nameid, this.newMessage).subscribe(function (message) {
            _this.messages.unshift(message); // add to start of the array
...
var PhotoEditorComponent = /** @class */ (function () {
    function PhotoEditorComponent(authService, userService, alertify) {
        ...
        this.userService = userService;
        this.alertify = alertify;
        this.getMemberPhotoChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"](); // photo URL
        this.hasBaseDropZoneOver = false;
        this.baeUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl;
    }
    ...
    PhotoEditorComponent.prototype.deletePhoto = function (id) {
        var _this = this;
        this.alertify.confirm('Are yoiu sure you want to delete this photo?', function () {
    ...
    MessagesComponent.prototype.deleteMessage = function (id) {
        ...
        this.alertify.confirm('Are you sure you want to delete this message?', function () {
            _this.userService.deleteMessage(id, _this.authService.decodedToken.nameid).subscribe(function () {
                _this.messages.splice(_this.messages.findIndex(function (m) { return m.id === id; }), 1); // dlete from view
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.prototype.login = function () {
        ...
        this.authService.login(this.model).subscribe(function (next) {
            _this.alertify.success('Loggen in succeessfully');
        }, function (error) {
            _this.alertify.error(error);
        }, function () {
            _this.router.navigate(['/members']);
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]])
    ], RegisterComponent);
...
module.exports = __webpack_require__(/*! C:\Repos\SocialApp\SocialApp-SPA\src\main.ts */"./src/main.ts");
